...
public class MapActivity extends AppCompatActivity {
                ...
                .setOnClickListener(
                        v -> {
                            if (map != null) {
                                ...
                                if (cam != null) {
                                    LatLngAltitude center = cam.getCenter();
                                    double rawHeading =
                                            cam.getHeading() != null ? cam.getHeading() : 0.0;
                                    ...
                                    Log.d(
                                            ...
                                            String.format(
                                                    ...
                                                    center.getLongitude(),
                                                    center.getAltitude(),
                                                    cam.getTilt() != null ? cam.getTilt() : 0.0,
                                                    heading,
                                                    cam.getRange() != null ? cam.getRange() : 0.0,
                                                    roll));
                                }
                            } else {
    ...
    protected void onStart() {
        super.onStart();
        if (map3DView != null) map3DView.onStart();
    }

    @Override
    protected void onResume() {
        super.onResume();
        if (map3DView != null) map3DView.onResume();
    }

    @Override
    protected void onPause() {
        if (map3DView != null) map3DView.onPause();
        super.onPause();
    }

    @Override
    protected void onStop() {
        if (map3DView != null) map3DView.onStop();
        super.onStop();
    }
    ...
    public void onLowMemory() {
        super.onLowMemory();
        if (map3DView != null) map3DView.onLowMemory();
    }

    @Override
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        super.onSaveInstanceState(outState);
        if (map3DView != null) map3DView.onSaveInstanceState(outState);
    }
}
