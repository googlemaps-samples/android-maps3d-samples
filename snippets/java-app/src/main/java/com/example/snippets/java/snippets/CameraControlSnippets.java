...
public class CameraControlSnippets {
    ...
    @SnippetItem(
            title = "1. Fly To",
            description =
                    "Animates the camera to a specific position with a tilt and heading over 5 seconds.")
    ...
    @SnippetItem(
            title = "2. Fly Around",
            description =
                    "Rotates the camera 360 degrees around a specific location over 10 seconds.")
    ...
    @SnippetItem(
            ...
            description =
                    "Logs to the console when the map finishes rendering or enters a steady state.")
    ...
    public void setCameraRestrictions() {
        Camera camera =
                new Camera(
                        new LatLngAltitude(40.748233, -73.985663, 1500.0), // center
                        0.0, // heading
                        45.0, // tilt
                        0.0, // roll
                        1000.0 // range
        ...
        LatLngBounds nycBounds = new LatLngBounds(40.856492, -73.802409, 40.685630, -74.050304);

        CameraRestriction restriction =
                new CameraRestriction(500.0, 10000.0, 0.0, 360.0, 0.0, 90.0, nycBounds);
