...
public class CloudStylingVisualTest extends BaseVisualTest {
    ...
    public void verifyCloudStylingRenders() {
        ...
        // Wait 15 seconds for Cloud-styled 3D map tiles to render and feature styling to settle
        System.out.println("Waiting 15 seconds for Cloud Map Styling 3D rendering...");
        try {
            Thread.sleep(15000);
