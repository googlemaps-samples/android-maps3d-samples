...
/**
 * Visual test for Polygons sample in Java app.
 */
@RunWith(AndroidJUnit4.class)
public class PolygonsVisualTest extends BaseVisualTest {

    @Test
    public void verifyPolygonsRenders() {
        // Launch PolygonsActivity
        Intent intent = new Intent(context, PolygonsActivity.class);
        ...
        Bitmap screenshotBitmap = captureScreenshot("polygons_screenshot.png");
