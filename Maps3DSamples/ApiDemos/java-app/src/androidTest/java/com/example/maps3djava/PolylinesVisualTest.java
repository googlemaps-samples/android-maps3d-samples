...
/**
 * Visual test for Polylines sample in Java app.
 */
@RunWith(AndroidJUnit4.class)
public class PolylinesVisualTest extends BaseVisualTest {

    @Test
    public void verifyPolylinesRenders() {
        // Launch PolylinesActivity
        Intent intent = new Intent(context, PolylinesActivity.class);
        ...
        Bitmap screenshotBitmap = captureScreenshot("polylines_screenshot.png");
