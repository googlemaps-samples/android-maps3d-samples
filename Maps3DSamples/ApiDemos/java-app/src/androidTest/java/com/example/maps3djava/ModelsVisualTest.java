...
/**
 * Visual test for Models sample in Java app.
 */
@RunWith(AndroidJUnit4.class)
public class ModelsVisualTest extends BaseVisualTest {

    @Test
    public void verifyModelsRenders() {
        ...
        Bitmap screenshotBitmap = captureScreenshot("models_screenshot.png");
