...
/**
 * Main activity of the Kotlin Views 3D Maps SDK Samples application.
 *
 * Integrates the unified Showcase catalog and framework switching.
 */
...
@Composable
fun KotlinShowcaseApp() {
    val context = LocalContext.current
    val prefs = remember { ShowcasePreferences.getInstance(context) }

    var selectedFramework by remember { mutableStateOf(prefs.preferredFramework ?: FrameworkType.KOTLIN_VIEWS) }
    var showFrontDoor by remember { mutableStateOf(false) }
