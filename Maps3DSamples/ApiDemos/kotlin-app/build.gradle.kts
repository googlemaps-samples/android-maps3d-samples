...
android {
    ...
    defaultConfig {
        applicationId = "com.example.maps3dkotlin"
...
tasks.register<Exec>("installAndLaunch") {
    ...
    commandLine(android.adbExecutable.absolutePath, "shell", "am", "start", "-n", "com.example.maps3dkotlin/.mainactivity.MainActivity")
}
